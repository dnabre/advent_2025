...
const char* day_11_test2_file = "inputs/2025/day_11_test_02.txt";
...
void run_all(void){
    ...
    const clock_t whole_end = clock();
    const double whole_elapsed_ms = (double)(whole_end - whole_start) * 1000.0 / CLOCKS_PER_SEC;
